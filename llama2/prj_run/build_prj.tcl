...
add_files -tb ../testbench/${project_name}_test.cpp -cflags "-std=c++0x"
add_files -tb ../testbench/tokenizer.cpp -cflags "-std=c++0x"
add_files -tb ../testbench/transformer_loader.h  -cflags "-std=c++0x"
add_files -tb ../testbench/sampling.cpp -cflags "-std=c++0x"
